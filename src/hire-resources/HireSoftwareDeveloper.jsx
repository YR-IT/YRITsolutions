...
import { ArrowRight, CheckCircle, Star, Users, Code, Globe, Smartphone, Database, Shield, Clock, DollarSign, Award, Headphones, Target, Trophy, Heart, ThumbsUp, Sparkles, MousePointer, Settings, Rocket, Zap, Cpu, Monitor, Server, Layers, Terminal, GitBranch, Package, Cloud, Lock, Gauge, Wrench, FileCode, Briefcase, Calendar } from 'lucide-react';
            ...
            isDarkMode 
              ...
              >
                ...
                <p className={`text-base sm:text-lg mb-6 max-w-2xl mx-auto px-4 sm:px-0 ${
                  ...
                  Join hundreds of successful companies who have transformed their business with our expert software developers. 
