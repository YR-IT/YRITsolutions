    ...
    <div className={`min-h-screen transition-all duration-500 ${
      ...
      >
        ...
        <div className="absolute inset-0">
          <motion.div 
            className="absolute inset-0 bg-gradient-to-br from-blue-600/30 via-cyan-600/20 to-indigo-600/30"
            animate={{
              background: [
                "linear-gradient(45deg, rgba(59, 130, 246, 0.3), rgba(6, 182, 212, 0.2), rgba(79, 70, 229, 0.3))",
                "linear-gradient(45deg, rgba(79, 70, 229, 0.3), rgba(59, 130, 246, 0.2), rgba(6, 182, 212, 0.3))",
                "linear-gradient(45deg, rgba(6, 182, 212, 0.3), rgba(79, 70, 229, 0.2), rgba(59, 130, 246, 0.3))"
              ]
            }}
          ...
          <div className="absolute bottom-5 sm:bottom-10 right-5 sm:right-10 w-64 sm:w-[500px] h-64 sm:h-[500px] bg-cyan-500/8 rounded-full blur-3xl opacity-20" />
        ...
        >
          ...
          >
            <motion.div
              ...
              className="inline-flex items-center px-3 sm:px-6 py-2 sm:py-3 rounded-full bg-gradient-to-r from-blue-500/30 to-cyan-500/30 border border-blue-500/40 mb-6 sm:mb-8 backdrop-blur-sm"
            >
              <Smartphone className="w-4 sm:w-5 h-4 sm:h-5 mr-2 sm:mr-3 text-blue-400" />
              <span className="text-xs sm:text-sm font-semibold">iOS Development Experts</span>
            ...
            >
              ...
              <br />
              <span className="text-white drop-shadow-2xl">iOS Developers</span>
              <br />
            ...
            >
              Build stunning native iOS applications with our expert Swift and Objective-C developers. 
              <span className="text-blue-400 font-semibold"> App Store ready</span>, 
              <span className="text-cyan-400 font-semibold"> native performance</span>, and 
              <span className="text-indigo-400 font-semibold"> seamless user experience</span>.
            </motion.p>
          </motion.div>
          ...
          >
            {[
              { number: "100+", label: "iOS Apps Built", icon: <Smartphone className="w-8 h-8" />, color: "text-blue-400" },
              { number: "15+", label: "iOS Developers", icon: <Users className="w-8 h-8" />, color: "text-cyan-400" },
              { number: "99%", label: "App Store Success", icon: <Trophy className="w-8 h-8" />, color: "text-indigo-400" },
              { number: "24/7", label: "Development Support", icon: <Headphones className="w-8 h-8" />, color: "text-blue-500" }
            ].map((stat, index) => (
              <motion.div 
                key={index} 
                initial={{ opacity: 0, scale: 0.8 }}
      ...
      {/* iOS Development Excellence Section */}
      <section className="py-12 sm:py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 sm:mb-6 px-4 sm:px-0">iOS Development Excellence</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            ...
            <motion.div
              ...
              className={`p-8 rounded-3xl ${isDarkMode ? 'bg-gray-800/30 border border-gray-700' : 'bg-white/50 border border-gray-200'} backdrop-blur-sm`}
            >
              <h3 className="text-2xl font-bold mb-6">iOS Technology Stack</h3>
      ...
      >
        ...
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-gradient-to-br from-blue-600/30 via-cyan-600/20 to-indigo-600/30"></div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className={`text-center p-8 sm:p-12 rounded-3xl backdrop-blur-xl border transition-all duration-300 ${
            ...
            <motion.h2 
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.8 }}
              className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-6 bg-gradient-to-r from-blue-400 via-cyan-400 to-indigo-400 bg-clip-text text-transparent"
            >
            ...
            >
              Get started with our expert iOS developers and bring your app idea to life on the App Store with cutting-edge technology.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              <motion.button 
                ...
                whileTap={{ scale: 0.95 }}
                className="group relative px-10 py-5 bg-gradient-to-r from-blue-600 via-cyan-600 to-indigo-600 text-white rounded-2xl font-semibold text-lg shadow-2xl hover:shadow-blue-500/30 transition-all duration-300 overflow-hidden min-w-[200px]"
            ...
            >
              <div className="flex flex-wrap justify-center items-center gap-8 text-sm">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className={isDarkMode ? 'text-gray-400' : 'text-gray-600'}>App Store Ready</span>
                </div>
                <div className="flex items-center space-x-2">
                  <div className="w-2 h-2 bg-cyan-500 rounded-full animate-pulse"></div>
                  <span className={isDarkMode ? 'text-gray-400' : 'text-gray-600'}>Swift Experts</span>
                </div>
              </div>
            </motion.div>
          </div>
