...
const TeamMemberCard = ({ member, index }) => {
  ...
  return (
    <div
      className={`group relative bg-gray-900 border border-gray-800 rounded-2xl shadow-2xl overflow-hidden transform transition-all duration-700 hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/20 animate-fade-in-up`}
        ...
        <div className="mb-4">
          <div className="flex flex-wrap gap-1">
            {member.skills.slice(0, 3).map((skill, skillIndex) => (
              <span
                key={skillIndex}
                className="text-xs bg-blue-900/50 text-blue-300 px-2 py-1 rounded-md border border-blue-800/50 hover:bg-blue-800/50 transition-colors"
              >
                {skill}
              </span>
            ))}
    ...
    <div className="min-h-screen bg-black">
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed animate-fade-in-up" style={{ animationDelay: '300ms' }}>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-white mb-4 animate-fade-in-up" style={{ animationDelay: '600ms' }}>
              Our Founders
            </h2>
            <p className="text-gray-300 max-w-2xl mx-auto animate-fade-in-up" style={{ animationDelay: '700ms' }}>
      ...
      {/* Team Section */}
      <section className="py-16 bg-gray-900/30 backdrop-blur-sm border-y border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-white mb-4 animate-fade-in-up" style={{ animationDelay: '900ms' }}>
              Our Team
            </h2>
            <p className="text-gray-300 max-w-2xl mx-auto animate-fade-in-up" style={{ animationDelay: '1000ms' }}>
