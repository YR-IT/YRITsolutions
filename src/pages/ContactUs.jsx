                    ...
                    <div className='w-full max-w-7xl mx-auto'>
                        ...
                        <div className='text-center mb-16 animate-fade-in'>
                            <div className='inline-block mb-6'>
                                ...
                                <div className='bg-gradient-to-r from-purple-400 to-violet-400 bg-clip-text text-transparent text-4xl md:text-5xl lg:text-6xl font-bold mb-4 animate-pulse'>
                                    Get In Touch
                                </div>
                            </div>
                            <div className='text-gray-300 text-base md:text-lg max-w-3xl mx-auto leading-relaxed animate-slide-up'>
                        ...
                        <div className='flex flex-col lg:flex-row gap-8 lg:gap-12 w-full'>
                            ...
                            <div className='bg-gradient-to-br from-gray-900 via-purple-900/50 to-gray-800 text-white rounded-3xl p-8 lg:p-12 flex-1 min-h-[520px] lg:min-h-[620px] relative shadow-2xl transform hover:scale-[1.02] transition-all duration-500 animate-slide-in-left border border-purple-500/20'>
                                ...
                                <div className='relative z-10 h-full flex flex-col'>
                                    ...
                                    <div className='mb-8 animate-fade-in'>
                                        <h2 className='text-2xl md:text-3xl lg:text-4xl font-bold mb-5 leading-tight bg-gradient-to-r from-white to-purple-200 bg-clip-text text-transparent'>
                                            Let's Connect
                                        </h2>
                                    ...
                                    <div className='flex-1 space-y-8 lg:space-y-10'>
                                        ...
                                        <div className='group flex items-center gap-6 p-4 rounded-2xl bg-purple-500/10 backdrop-blur-sm hover:bg-purple-500/20 transition-all duration-300 transform hover:scale-105 animate-slide-in-left border border-purple-500/20' style={{animationDelay: '0.2s'}}>
                                            ...
                                            <div>
                                                ...
                                                <a href="tel:+917404890806" className='text-base md:text-lg lg:text-xl font-semibold hover:text-purple-200 transition-colors'>
                                                    +91 7404890806 
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div className='group flex items-center gap-6 p-4 rounded-2xl bg-purple-500/10 backdrop-blur-sm hover:bg-purple-500/20 transition-all duration-300 transform hover:scale-105 animate-slide-in-left border border-purple-500/20' style={{animationDelay: '0.4s'}}>
                                            ...
                                            <div>
                                                ...
                                                <div 
                                                    className='text-base md:text-lg lg:text-xl font-semibold cursor-pointer hover:text-purple-200 transition-colors break-all'
                                    ...
                                    <div className='mt-8 animate-fade-in' style={{animationDelay: '1s'}}>
                                        <div className='text-base font-semibold mb-3 text-purple-300'>Follow Us</div>
                        ...
                        <div className='mt-10 text-center animate-fade-in' style={{animationDelay: '1.2s'}}>
